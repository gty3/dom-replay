  ...
  if (
    ...
    return (
      <div className="relative w-16">
        <div className="flex justify-center items-center h-8 border-t" />
    ...
    return (
      <div className="">
        <button
          onClick={onClick}
          className={`flex relative justify-center items-center w-16 h-8 text-gray-300 ${style}`}
        >
          <div
            className={`flex justify-center items-center -mx-1 w-16 h-8 border-t ${color}`}
          >
            <div>{limits}</div>
